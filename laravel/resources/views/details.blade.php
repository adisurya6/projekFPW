                    ...
                    <div class="single-job-items mb-50">
                        ...
                        <div class="job-items">
                            ...
                            <div class="job-tittle">
                                ...
                                <ul>
                                    <li style="font-size:12px;">{{$job->Company->name}}</li>
                                    <li style="font-size:12px;"><i class="fas fa-map-marker-alt"></i>{{$job->company->address}}</li>
                                    <li style="font-size:12px;">Rp.{{$job->min}} - Rp.{{$job->max}}</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-4 col-lg-4">
                    <div class="post-details3  mb-50">
                      ...
                      <ul>
                          ...
                          <li>Salary :  <span>Rp.{{number_format($job->min, 2, ',','.')}} - Rp.{{number_format($job->max, 2, ',','.')}}</span></li>
